...
I will calculate the total average of steps taken per "day", considering an applied function that adds the total steps per date, then I will calculate the average of StepsPerDay.
...
most_of_steps <- gsub("([0-9]{1,2})([0-9]{2})", "\\1:\\2", ave_day_act_patt[MaxSteps, "interval"])
most_of_steps
```
